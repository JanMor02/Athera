package net.athera.atherasurvival.util.management;
...
import net.athera.atherasurvival.util.interfaces.INutritionManagement;
 ...
 * @author Jan
 */
public class NutritionManagement implements INutritionManagement {
